  ...
  module EC2
    ...
    class Base < AWS::Base
      ...
      def request_spot_instances( options = {} )
        ...
        raise ArgumentError, ":instance_type must specify a valid instance type" unless options[:instance_type].nil? || valid_instance_types.include?(options[:instance_type])
